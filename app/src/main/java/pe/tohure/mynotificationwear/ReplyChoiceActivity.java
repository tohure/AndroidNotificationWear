...
public class ReplyChoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reply_choice);
    ...
    private CharSequence getMessageText(Intent intent) {
        ...
        if (remoteInput != null){
            return remoteInput.getCharSequence(MainActivity.EXTRA_VOICE_REPLY_CHOICE);
        }
        return "";
    }
